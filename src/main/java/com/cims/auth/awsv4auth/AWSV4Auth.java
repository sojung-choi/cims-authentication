package com.cims.auth.awsv4auth;
...
public class AWSV4Auth  {
    ...
    public static class Builder {
        ...
        private String canonicalURI; //안넣었음
        private TreeMap<String, String> queryParametes;
        private TreeMap<String, String> awsHeaders;
        private String payload;//안넣었음
...
// 인증 헤더 만들기
     ...
     * @return
     *
     * Credential=AKIA3XAHCYIEIYYT76DA/20210728/us-east-1/iam/aws4_request
     */
     ...
     * @return
     *
     * Signature=baf954eb9a151e89eb52a92c288995fb7917eca940f620b501c5c82a2b06c610
     */
     ...
     * 위에서 계산한 값들 바탕으로, 최종 header값 세팅(Credential, Signature포함)
     *
     * @return
     *
     * x-amz-date = 20210728T050156Z
     * Authorization = AWS4-HMAC-SHA256 Credential=AKIA3XAHCYIEIYYT76DA/20210728/us-east-1/iam/aws4_request,SignedHeaders=host;x-amz-date,Signature=baf954eb9a151e89eb52a92c288995fb7917eca940f620b501c5c82a2b06c610
     */
    ...
    public HeaderVO getHeaderVO() {
        ...
        if (signature != null) {
            HeaderVO headerVO = new HeaderVO(xAmzDate, buildAuthorizationString(signature));
            if (debug) {

                headerVO.setAuthorization(buildAuthorizationString(signature));
            }
            return headerVO;
        } else {
            if (debug) {
